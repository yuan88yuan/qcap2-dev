...
QCAP_EXT_API QRESULT QCAP_EXPORT QCAP_GET_VIDEO_RECORD_PROPERTY_EX( PVOID pDevice /*IN*/, UINT iRecNum /*IN*/, UINT * pGpuNum /*OUT*/, ULONG * pEncoderType /*OUT*/, ULONG * pEncoderFormat /*OUT*/, ULONG * pRecordProfile /*OUT*/ DEFVAL( BASELINE /*OUT*/), ULONG * pRecordLevel /*OUT*/ DEFVAL( 41 /*OUT*/), ULONG * pRecordEntropy /*OUT*/ DEFVAL( CAVLC /*OUT*/), ULONG * pRecordComplexity /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pRecordMode /*OUT*/, ULONG * pQuality /*OUT*/, ULONG * pBitRate /*OUT*/, ULONG * pGOP /*OUT*/, ULONG * pBFrames /*OUT*/ DEFVAL( 0 /*OUT*/), BOOL * pIsInterleaved /*OUT*/ DEFVAL( FALSE /*OUT*/), ULONG * pSlices /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pLayers /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pSceneCut /*OUT*/ DEFVAL( 0 /*OUT*/), BOOL * pMultiThread /*OUT*/ DEFVAL( TRUE /*OUT*/), BOOL * pMBBRC /*OUT*/ DEFVAL( FALSE /*OUT*/), BOOL * pExtBRC /*OUT*/ DEFVAL( FALSE /*OUT*/), ULONG * pMinQP /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pMaxQP /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pVBVMaxRate /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pVBVBufSize /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pCBRVariation /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pAspectRatioX /*OUT*/, ULONG * pAspectRatioY /*OUT*/, ULONG * pCropX /*OUT*/, ULONG * pCropY /*OUT*/, ULONG * pCropW /*OUT*/, ULONG * pCropH /*OUT*/, ULONG * pDstW /*OUT*/, ULONG * pDstH /*OUT*/, ULONG * pPostSkipFrameRate /*OUT*/ DEFVAL( 0 /*OUT*/), ULONG * pPostAvgFrameRate /*OUT*/ DEFVAL( 0 /*OUT*/ )); // HARDWARE ENCODER NEED USE QCAP_GET_VIDEO_HARDWARE_ENCODER_PROPERTY_EX
